...
import { updateUser } from "../../store/usersThunk";
...
export const  Editar = () => {
    ...
    const schema = yup.object().shape({
      ...
      async function create (data) {
        ...
        await axios.patch('https://fakestoreapi.com/users/'+ id.id, jsonData)
          .then(res => jsonData.id = id.id)
          .then(res => {
            console.log(res.data, jsonData)
            dispatch(updateUser(jsonData, dispatch))
            history.push("/")
          })
      }
